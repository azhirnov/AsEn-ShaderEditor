...
Примеры:
* [простой пост-эффект](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/scripts/posteffects/Distortion-1.as)
* [сложение искажений](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/scripts/posteffects/Distortion-2.as)
