...
Здания рисуются инстансингом, можно еще оптимизировать, если объединить разную геометрию в один вызов рисования, а в шейдере читать вершины со смещением в зависимости от типа здания.
Количество вершин у каждого здания примерно совпадает, достаточно выбрать максимальное значение.
