...
//
// [shader](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/shaders/tools/TerrainNoise.glsl)
//
// functions:
...
void  SetupTerrainNoise (SetupPasses_t @setupPasses)
{
...

	{
		...
		pass.AddPipeline( "tools/Terrain.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/tools/Terrain.as)
