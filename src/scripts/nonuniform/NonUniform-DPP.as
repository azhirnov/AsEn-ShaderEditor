...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
...

		{
			...
			RunScript( "NonUniform-GenImages.as", ScriptFlags::RunOnce, args );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/scripts/callable/NonUniform-GenImages.as)
		}
		...
		{
			RC<SceneGraphicsPass>	pass = scene_dpp.AddGraphicsPass( "depth pre pass" );
			pass.AddPipeline( "perf/NonUniform/DPP.as" );		// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/DPP.as)
		...
		uint	mode_id = 0;
		{
			...
			pass.AddPipeline( "perf/NonUniform/Tex1.as" );		// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/Tex1.as)
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/Tex2.as" );		// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/Tex2.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.Output(				ds );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/Samp.as" );		// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/Samp.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.Output(				ds );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/Tex1-PerWarp.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/Tex1-PerWarp.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.Output(				ds );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/Tex2-PerWarp.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/Tex2-PerWarp.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.Output(				ds );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/Samp-PerWarp.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/Samp-PerWarp.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.Output(				ds );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/Tex1-PerQuad.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/Tex1-PerQuad.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.Output(				ds );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/Tex2-PerQuad.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/Tex2-PerQuad.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.Output(				ds );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/Samp-PerQuad.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/Samp-PerQuad.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.Output(				ds );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/Tex1-PerPix.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/Tex1-PerPix.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.Output(				ds );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/Tex2-PerPix.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/Tex2-PerPix.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.Output(				ds );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/Samp-PerPix.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/Samp-PerPix.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.Output(				ds );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
