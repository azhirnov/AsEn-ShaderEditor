...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
...

		{
			...
			pass.AddPipeline( "perf/NonUniform/VisBuf1.as" );		// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VisBuf1.as)
		...
		uint	mode_id = 0;
		{
			...
			pass.AddPipeline( "perf/NonUniform/VB-Tex1.as" );		// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VB-Tex1.as)
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/VB-Tex2.as" );		// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VB-Tex2.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.ArgTex(  "un_VisBuf",	vis );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/VB-Samp.as" );		// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VB-Samp.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.ArgTex(  "un_VisBuf",	vis );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/VB-Tex1-PerWarp.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VB-Tex1-PerWarp.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.ArgTex(  "un_VisBuf",	vis );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/VB-Tex2-PerWarp.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VB-Tex2-PerWarp.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.ArgTex(  "un_VisBuf",	vis );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/VB-Samp-PerWarp.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VB-Samp-PerWarp.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.ArgTex(  "un_VisBuf",	vis );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/VB-Tex1-PerQuad.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VB-Tex1-PerQuad.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.ArgTex(  "un_VisBuf",	vis );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/VB-Tex2-PerQuad.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VB-Tex2-PerQuad.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.ArgTex(  "un_VisBuf",	vis );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/VB-Samp-PerQuad.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VB-Samp-PerQuad.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.ArgTex(  "un_VisBuf",	vis );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/VB-Tex1-PerPix.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VB-Tex1-PerPix.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.ArgTex(  "un_VisBuf",	vis );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/VB-Tex2-PerPix.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VB-Tex2-PerPix.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.ArgTex(  "un_VisBuf",	vis );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
		...
		++mode_id;
		{
			...
			pass.AddPipeline( "perf/NonUniform/VB-Samp-PerPix.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/NonUniform/VB-Samp-PerPix.as)
			pass.Output( "out_Color",	rt,		RGBA32f(1.0, 0.0, 0.0, 0.0) );
			pass.ArgTex(  "un_VisBuf",	vis );
			pass.Constant( "iTexBias",	tex_bias );
			pass.EnableIfEqual( mode, mode_id );
