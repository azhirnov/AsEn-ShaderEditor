	...
	//	const EPixelFormat	hdr_fmt	= EPixelFormat::R11G11B10F;	// HDR on mobile
		...
		// render loop
		{
			...
			// Downscale
			{
				...
				pass.AddPipeline( "perf/Blur-6-down.as" );		// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/Blur-6-down.as)
			...
			// Upscale
			{
				...
				pass.AddPipeline( "perf/Blur-6-up.as" );		// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/Blur-6-up.as)
