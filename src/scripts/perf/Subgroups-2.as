...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		// render loop
		{
			...
			pass.AddPipeline( "perf/Subgroups-2a.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/Subgroups-2a.as)
			...
			RC<SceneGraphicsPass>	pass = scene.AddGraphicsPass( "draw" );
			pass.AddPipeline( "perf/Subgroups-2b.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/Subgroups-2b.as)
			pass.Output(   "out_Color",		rt,		RGBA32f(0.0) );
			pass.Constant( "iMode",			mode );
			pass.Constant( "iWithOffset",	with_offset );
			pass.Constant( "iScale",		scale );
			...
			pass.AddPipeline( "perf/Subgroups-2c.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/perf/Subgroups-2c.as)
			pass.Output(   "out_Color",		rt,		RGBA32f(0.0) );
			pass.Constant( "iMode",			mode );
			pass.Constant( "iScale",		scale );
			pass.Constant( "iHash",			hash );
