...
void ASmain ()
{
	Assert( Supports_TessellationShader(), "required tessellation shader support" );
	...
	// generate cubemap
	{
		...
		RunScript( "GenPlanet.as", ScriptFlags::RunOnce, args );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/scripts/callable/GenPlanet.as)
	}

	// render loop
	{
		RC<SceneGraphicsPass>	draw = scene.AddGraphicsPass( "main pass" );
		draw.AddPipeline( "samples/Planet-2.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/samples/Planet-2.as)
