...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		// render loop
		{
			...
			draw.AddPipeline( "samples/Model.as" );		// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/samples/Model.as)
		...
		}
		{
			...
			pass.SetPipeline( "samples/Model-RT.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/samples/Model-RT.as)
