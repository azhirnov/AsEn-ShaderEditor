...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		// render loop
		{
			...
			draw_pass.AddPipeline( "samples/DeferredTexturing-pass1.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/tree/main/src/pipelines/samples/DeferredTexturing-pass1.as)
			...
			draw_pass.AddPipeline( "samples/DeferredTexturing-pass2.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/tree/main/src/pipelines/samples/DeferredTexturing-pass2.as)
