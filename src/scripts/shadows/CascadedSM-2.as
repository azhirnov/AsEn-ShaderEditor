...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		// render loop
		{
			...
			pass.AddPipeline( "samples/StreetLights/CSM-mask.as" );		// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/samples/StreetLights/CSM-mask.as)
