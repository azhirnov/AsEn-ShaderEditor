...
/*
	Press 'F3' to export Cube map to a file.
*/
...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		// render loop
		{
			...
			draw.AddPipeline( "samples/Cubemap.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/samples/Cubemap.as)
			draw.Output( "out_Color", rt, RGBA32f(0.0) );
		}

		Export( cubemap_view, "exported-image-cm-.aeimg" );
		Present( rt );
	}
