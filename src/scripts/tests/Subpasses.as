...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		// render loop
		{
			...
			{
				draw.AddPipeline( "tests/Subpass1.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/tests/Subpass1.as)
			...
			{
				draw.AddPipeline( "tests/Subpass2.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/tests/Subpass2.as)
