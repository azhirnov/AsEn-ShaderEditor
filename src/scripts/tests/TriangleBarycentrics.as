...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		// render loop
		{
			...
			pass.AddPipeline( "tests/TriangleBarycentrics.as" );	// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/tests/TriangleBarycentrics.as)
			...
			pass.AddPipeline( "tests/UVDerivatives.as" );			// [src](https://github.com/azhirnov/AsEn-ShaderEditor/blob/main/src/pipelines/tests/UVDerivatives.as)
			pass.Output( "out_Color",	rt,		RGBA32f(0.0) );
